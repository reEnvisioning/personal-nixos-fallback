...
Item {
    ...
    RowLayout {
        ...
        ColumnLayout {
            ...
            RowLayout {
                spacing: 4
                Text { text: "CPU"; color: root.colors.subtext0; font.pointSize: 9; font.weight: Font.DemiBold }
                Text { text: root.cpuModel; color: root.colors.text; font.pointSize: 9; elide: Text.ElideRight }
            }
        }
    }
}
